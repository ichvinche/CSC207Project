...
public class BoggleStats {
    ...
    public void addWord(String word, Player player) {
        if (Objects.equals(player.player, "Human")) {
            this.playerWords.add(word.toUpperCase());
    ...
    public void summarizeRound() {
        System.out.println("===== SUMMARY OF ROUND =====\nPlayer Words: " + this.playerWords +
                "\nComputer Words: " + this.computerWords + "\n\nPlayer Words Count: " + this.playerWords.size() +
                "\nComputer Words Count: " + this.computerWords.size() + "\n\nPlayer Score: " + this.pScore +
                "\nComputer Score: " + this.cScore);
    }
    ...
    public void summarizeGame() {
        ...
        System.out.println("===== SUMMARY OF GAME =====\nTotal Rounds Played: " + this.round +
                "\n\nTotal Player Score: " + this.pScoreTotal + "\nTotal Computer Score: " + this.cScoreTotal +
                "\n\nAverage Words for Player: " + this.pAverageWords + "\nAverage Words for Computer: " +
                this.cAverageWords);
    }
